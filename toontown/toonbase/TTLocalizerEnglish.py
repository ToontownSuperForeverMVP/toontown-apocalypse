...
ActionBuildingFloorCleared = 'FLOOR %d CLEARED!'
ActionBuildingNextFloorHint = 'Take the elevator to the next floor.'
ActionBuildingExtractedTitle = 'BUILDING CLEARED!'
ActionBuildingExtracted = 'Extraction bonus: +%d beans.'
ActionDodged = 'DODGED!'
...
ActionEndExtractedTitle = 'BUILDING EXTRACTED'
ActionEndExtractedSub = 'The top floor fell. The block is Toon-owned again.'
